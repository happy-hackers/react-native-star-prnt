...
- (void)refreshDisplay {
    ...
    if ([self connect] == NO) {
        UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"Communication Result"
...
//          _port = [SMPort getPort:portName :@"(your original portSettings);l1000)" :10000 :&error];
            _port = [SMPort getPort:portName :[AppDelegate getPortSettings] :10000 :&error];    // 10000mS!!!
            ...
            [_port getParsedStatus:&status :2 :&error];
