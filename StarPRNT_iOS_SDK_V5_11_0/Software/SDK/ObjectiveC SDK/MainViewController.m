    ...
    switch (_selectedIndexPath.section) {
        ...
        case SectionIndexBluetooth :
            if (_selectedIndexPath.row == 0) {
                ...
                [Communication disconnectBluetooth:modelName
                                          portName:portName
                                      portSettings:portSettings
                                           timeout:10000
                                 completionHandler:^(CommunicationResult *communicationResult) {     // 10000mS!!!
                                     NSMutableString *message = [NSMutableString stringWithString:[Communication getCommunicationResultMessage:communicationResult]];
...
- (void)confirmSerialNumber {
    ...
    [Communication confirmSerialNumber:portName
                          portSettings:portSettings
                               timeout:timeout
                     completionHandler:^(CommunicationResult *communicationResult, NSString *message) {
                         ...
                         [self showSimpleAlertWithTitle:@"Product Serial Number"
