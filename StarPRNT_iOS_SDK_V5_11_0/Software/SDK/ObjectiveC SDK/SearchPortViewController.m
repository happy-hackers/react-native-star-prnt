...
- (void)didSelectRefreshPortWithButtonIndex:(NSInteger)buttonIndex {
    ...
    switch (buttonIndex) {
        case 0:     // LAN
            portInfoArray = [SMPort searchPrinter:@"TCP:" :&error];
            break;
        case 1:     // Bluetooth
            portInfoArray = [SMPort searchPrinter:@"BT:" :&error];
            break;
        case 2:     // Bluetooth Low Energy
            portInfoArray = [SMPort searchPrinter:@"BLE:" :&error];
            break;
        case 3:     // USB
            portInfoArray = [SMPort searchPrinter:@"USB:" :&error];
            break;
        case 4:     // All
