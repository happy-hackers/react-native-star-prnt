...
- (void)viewDidLoad {
    ...
    [_volumeLabel setText:[NSString stringWithFormat:@"%lu", (unsigned long)_selectedVolume]];
...
- (IBAction)changedVolume:(id)sender {
    ...
    _volumeLabel.text = [NSString stringWithFormat:@"%lu", (unsigned long)newValue];
}
...
//  port = [SMPort getPort:portName :@"(your original portSettings);l1000)" :10000 :&error];
    port = [SMPort getPort:portName :[AppDelegate getPortSettings] :10000 :&error];    // 10000mS!!!
