...
======================
    ...
    [Support OS]
        - Supported OS version: 9.0 or later

    [StarIO]
        - Added features
            * Added (NSError **)error parameter to getPort method, searchPrinter method、disconnect method.
            * Added features for error handling
                Get the error code with the code property of the (NSError **)error parameter.
                Target methods (existing method is deprecated)
                    getPort
                    beginCheckedBlock
                    endCheckedBlock
                    writePort
                    ...
                    disconnect
        - Fixed Bugs
            * Fixed a bug that function is failed when using Apple AirMac series printer sharing function or HE05/06.
